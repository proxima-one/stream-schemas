...
interface IEthereumTransactionsService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {}

export const EthereumTransactionsService: IEthereumTransactionsService;

export interface IEthereumTransactionsServer
  extends grpc.UntypedServiceImplementation {}

export interface IEthereumTransactionsClient {}

export class EthereumTransactionsClient
  extends grpc.Client
  implements IEthereumTransactionsClient
{
  constructor(
    address: string,
