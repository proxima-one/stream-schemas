...
@TypeGraphQL.InputType("OfferUpdateWithWhereUniqueWithoutMangroveInput", {
  isAbstract: true
})
export class OfferUpdateWithWhereUniqueWithoutMangroveInput {
  ...
  data!: OfferUpdateWithoutMangroveInput;
}
